#!/usr/bin/perl -w
# merge-pinyin.pl --- Merge two eim-py table
...
merge-pinyin.pl - A utility to merge two eim-pinyin table file

=head1 SYNOPSIS

merge-pinyin.pl prime-table added-table [-o new_table]
...
You may use this utility to update or enlarge your eim-pinyin table file
