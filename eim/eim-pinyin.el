;;; -*- coding: utf-8 -*-
;;; eim-pinyin.el --- emacs chinese pinyin input method for eim
...
(unless eim-py-initialized
  ...
  (let ((eim-current-package eim-py-package))
    (let ((map (eim-mode-map)))
      ...
      (define-key map "\M-n" 'eim-py-next-page)
      (define-key map "\M-p" 'eim-py-previous-page)
